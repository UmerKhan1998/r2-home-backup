...
const Inside = ({
  ...
  const GetStream = async (
    ...
    window.scrollTo(0, 0);
    try {
      const response = await endpoints.GetStream(
        authToken,
        courseTrainingRegistrationId,
        courseTrainingFileId
      );
      if (response?.data?.statusCode === "200") {
        setCourseVideoState(
          `${process.env.NEXT_PUBLIC_API_KEY}/api/mediastream/v1/MediaStreamServices/GetStreamById?Id=${response?.data?.data?.id}&Token=bearer ${authToken}`
        );
  ...
  const GetStreamCourseTrainingDemoVideo = async (
    courseTrainingId,
    Language
  ) => {
    try {
      const response = await endpoints.GetStreamCourseTrainingDemoVideo(
        authToken,
        courseTrainingId,
        Language
      );
      if (response?.data?.statusCode === "200") {
        setCourseVideoState(
          `${process.env.NEXT_PUBLIC_API_KEY}/api/mediastream/v1/MediaStreamServices/GetStreamCourseTrainingDemoVideoById?Id=${response?.data?.message}`
        );
      }
    } catch (error) {
      console.log("error", error);
  ...
  const [CustomVideoDemoPlayerState, setCustomVideoDemoPlayerState] =
    useState(true);
  const [CustomVideoPlayerBoolState, setCustomVideoPlayerBoolState] =
    useState(false);
  ...
  const TabsArray = [
    ...
    <CourseReview>
      ...
      <Row style={{ alignItems: "center" }}>
        <Col span={5}>
          <div className="course-rating">
            <div className="number">{courseReviews?.rating}</div>
            <div className="rating-img">
              <StyledRate disabled value={courseReviews?.rating} />
            </div>
            <div className="rating-txt">{Category} Rating</div>
          </div>
        </Col>
        <Col span={19}>
      ...
      <ReviewComments>
              ...
              <div className="review-card" key={index}>
                ...
                <div className="review-card-text">
                  ...
                  <div className="review-date">
                    <StyledRate disabled value={item?.rating} />
                  </div>
                  <p>{item?.review_EN}</p>
        ...
        {courseReviews?.totalRecord === 0 ? (
          ...
          <>
            {ReviewCommentCount < courseReviews?.totalRecord &&
      ...
      <div className="discussion-comment">
        <div className="discussion-comment-input">
          ...
          <div className="discussion-input">
            <input
              ...
              value={addDiscussionParamsState?.discussion_EN}
              maxLength={1500}
              onKeyPress={(e) => {
                if (e?.key === "Enter") {
        ...
        <div className="discussion-comment-cards">
          {courseDiscussionComments?.dashboardInsideDiscussionViewModels
            ...
            .map((item, index) => (
              <div className="discussion-comment-card" key={index}>
          ...
          courseDiscussionComments?.totalRecord === undefined ? (
            ...
            <>
              ...
              {DiscussionCommentCount <
                ...
                courseDiscussionComments?.totalRecord !== 3 && (
    ...
    <CertificateTab>
      <p>Get R2 Certificate by completing entire {Category}</p>
            ...
            <>
              {CertificateRequestLoading ? (
                <a disabled>
                  ...
                  <Image alt={""} src={Rolling} width="16px" height="16px" />
                </a>
              ) : (
                <a
                  onClick={(e) => {
      ...
      {courseDetailState?.category === "Synchronous" && (
        <>
          {certificateRequest && (
            <>
              {courseDetailState?.certificateRequest &&
                courseDetailState?.certificateIssue === false && (
                  <>
                    ...
                    {(courseDetailState?.certificateStatus === "" ||
                      courseDetailState?.certificateStatus === null) && (
                      <span>You have already applied for the certificate</span>
                    )}
                  </>
                )}
              {courseDetailState?.certificateRequest &&
          ...
          {/* {(!certificateRequest) && (
                    // <button disabled>Request for Certificate</button>
                    <button
                        onClick={(e) => {
                            e.preventDefault();
                            getCertificateRequestFunc()
                        ...
                        disabled={(CertificateRequestLoading) && ('disabled')}
                    >Request for Certificate {(CertificateRequestLoading) && (<img loading="lazy"alt={""} src={Rolling} width="16px" height="16px" />)}</button>
                )} */}
        </>
      )}
    </CertificateTab>,
        ...
        <Col span={24} lg={15}>
          <CourseInsideDetail>
            ...
            <div className="course-inside-desc">
              ...
              <p>
                Instructor:{" "}
                {courseDetailState?.instructorName_EN === undefined ? (
                  <SkeletonTextPlaceholder width="50%" />
                ) : (
                            ...
                            <>
                              {item?.fileTypeRecord === "File" && (
                                ...
                                >
                                  ...
                                  <span className="dropmenu-parent">
                                    ...
                                    {item?.dashboardInsideResourceViewModels
                                      .length != 0 && (
                              ...
                              {item?.fileTypeRecord === "Survey" && (
                                <>
                                  {item?.viewed ? (
                                    <div
                                      className={`curriculum-module-lesson download active disabled`}
                                      key={index}
                                    >
                                      <h4>
