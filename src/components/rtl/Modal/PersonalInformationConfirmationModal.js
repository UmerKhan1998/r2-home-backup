...
import {
  continue_p,
  edit_p,
  please_confirm_below_details,
  please_confirm_below_details_para_confirmation,
      ...
      {openModal && (
        <StyledDiv dir="rtl">
          <ModalDiv>
            ...
            <h1>{please_confirm_below_details}!</h1>
            ...
            <ButtonRow>
              ...
              <CustomButton
                ...
                onClick={() => {
                  ...
                  setCookies("lastName_AR", signInState?.lastName_AR);
                  setCookies("firstName_AR", signInState?.firstName_AR);
                }}
              >
                {continue_p}
              </CustomButton>
