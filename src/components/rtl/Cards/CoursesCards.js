                    ...
                    {(percent === 0) && (
                      <Link href={`${checkType(type)}-${DetailPageSlug}`}>
                        <a>
                          ...
                          >
                            <span className="continue_learning"> {Start_Learning} </span>
                          </CustomButton>
                        </a>
                      </Link>
                    )}
                    {(percent < 100 && percent > 0) && (
                      <Link href={`${checkType(type)}-${DetailPageSlug}`}>
                        <a>
                          ...
                          >
                            <span className="continue_learning"> {Continue_Learning} </span>
                          </CustomButton>
                        </a>
                      </Link>
                    )}
                    {(percent === 100) && (
                      <Link href={`${checkType(type)}-${DetailPageSlug}`}>
                        <a>
                          ...
                          >
                            <span className="continue_learning"> {Generate_Certificate} </span>
                          </CustomButton>
                        </a>
                      </Link>
                    )}
                  </>) : (
                    <Link href={`training-${DetailPageSlug}`}>
                      <a>
                        <CustomButton
                          customStyle={{
                            border: "1px solid #105F43",
                        ...
                        >
                          <span className="continue_learning"> {Enroll_Now} </span>
                        </CustomButton>
                      </a>
                    </Link>
                  )}
