...
const Hero = ({
  ...
  const heroCarouselArr = [
    ...
    },
    {
      ...
      heading: "مطلوب تدريب رخصة SCFHS",
      paragraph:
  ...
  const webinarsSuggestionsArr = [
    { label: `${Discounted}`, value: "Discounted Webinars" },
    { label: `${SelfPaced}`, value: "Self-paced Webinars" },
    { label: `F2F`, value: "F2F Webinars" },
    { label: `${free}`, value: "Free Webinars" },
    { label: `${Discounted}`, value: "Discounted" },
    { label: `${SelfPaced}`, value: "Self-paced" },
  ...
  const programsSuggestionsArr = [
    { label: `${Discounted}`, value: "Discounted Programs" },
    { label: `${SelfPaced}`, value: "Self-paced Programs" },
    { label: `F2F`, value: "F2F Programs" },
    { label: `${free}`, value: "Free Programs" },
    { label: `${Discounted}`, value: "Discounted" },
    { label: `${SelfPaced}`, value: "Self-paced" },
    { label: `F2F`, value: "F2F Programs" },
    { label: `${free}`, value: "Free Programs" },
            ...
            <HomeContainer>
              {!loadingHead && (
                <>
                  ...
                  >
                    {sliderData[carouselIndex]?.title_AR?.length > 50
                      ? `${sliderData[carouselIndex]?.title_AR?.slice(
                          0,
                          50
                        )}...`
                      : sliderData[carouselIndex]?.title_AR}
                  </h1>
                  {/* <div className={"p-div"}>
                <p>{heroCarouselArr[carouselIndex]?.paragraph} </p>
                  ...
                  <div className="HeroBtn">
                    ...
                    >
                      {sliderData[carouselIndex]?.buttonTitle_AR?.length > 35
                        ? `${sliderData[carouselIndex]?.buttonTitle_AR?.slice(
                            0,
                            35
                          )}...`
                        : sliderData[carouselIndex]?.buttonTitle_AR}
                    </CustomButton>
                  </div>
                </>
              )}
          ...
          <CourseDetailHeroContent2>
            <AboutUsContainer dir="rtl">
              ...
              <CourseDetailsEnorllmentRow>
                ...
                {/* </CourseDetailsEnorllmentCol> */}
                {/* <CourseDetailsEnorllmentCol span={4}> */}
                <CourseDetailsEnorllmentRateDiv span={24}>
...
const SearchPanelConference = styled.div`
  background-color: rgba(0, 0, 0, 0.3);
  padding: 15px 10px !important;
  border-radius: 10px;
  height: 104px;
...
const CourseDetailsEnorllmentRateDiv = styled(Col)`
  display: flex;
  align-items: center;
  p {
    margin-bottom: 0px;
