      ...
      <CourseCurriculumDiv>
        ...
        <CourseCurriculumRowMBottom>
          ...
          <CurricullumContentCol span={8}>
            ...
            <CurricullumContentDiv>
              <h2>{getCourseDetailId?.duration_EN}</h2>
              <p>Total</p>
            </CurricullumContentDiv>
          </CurricullumContentCol>
        </CourseCurriculumRowMBottom>
        {getCourseDetailId?.demoVideo_EN !== "" && (
          <StyledCollapse
                ...
                <Row>
                  <StyledCollapseCol span={22}>
                    <p
                      onClick={() => {
                        setOpenModal(true);
                        setUrlState(getCourseDetailId?.demoVideo_EN);
                      }}
                    >
        ...
        {getCourseDetailId?.detailRecordCourseTrainingViewModels?.map(
          (item, index) => (
            <div key={index}>
              <StyledRecordTypeH1>{item?.recordType}</StyledRecordTypeH1>
              {item?.detailRecordSectionViewModel?.map((item, index) => (
                <>
                  ...
                  <StyledCollapse
                    ...
                    ghost
                  >
                    <Panel header={`${item?.title_EN}`} key={index}>
                      {item?.detailRecordFileViewModels?.length > 0 && (
                        <>
                          {item?.detailRecordFileViewModels?.map(
                            (item, index) => (
