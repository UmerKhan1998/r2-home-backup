              ...
              setSupportState({
                ...
                <Row gutter={[16, 8]}>
                  <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                    ...
                    {nameState && (
                      <>
                        {(supportState?.your_name?.trim() === ""||supportState?.your_name?.trim() === "undefined undefined") && (
...
{selectDepartmentState&&
                  ...
                  <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                    ...
                    <div style={{ position:"relative" }}>
{/* {console.log(getAllRequestaServiceLovState?.find(item=>item?.title_EN===supportState?.select_service)?.id,'getAllRequestaServiceLovState?.find')} */}
                    <StyledSelect
                      // value="Select"
                      ...
                      onChange={(value) =>
                        setSupportState({
                          ...
                          service_id: getAllRequestaServiceLovState?.find(item=>item?.title_EN===value)?.id,
                        })
                      }
                      // options={getAllRequestaServiceLovState}
                    >
