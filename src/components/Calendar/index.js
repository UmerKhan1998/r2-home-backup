    ...
    height: "100px"
                ...
                {item?.venueType==="Survey"&& (<>
                  {(!item?.viewed) ? (
                    ...
                    <img loading="lazy"src={SurveryIcon} style={{ marginRight:5 }} />                
                    </div>
                  ) : (
                ...
                {item?.venueType==="Assessment"&& (<>
                    ...
                    <img loading="lazy"src={AssessmentIcon} style={{ marginRight:5 }} />                
                    </div>
                </>)}
                {item?.venueType==="Onsite"&& (<>
                    <div style={{ cursor:"pointer" }}>
                    <img loading="lazy"src={WebinarImg2} style={{ marginRight:5 }} />                
                    </div>
                </>)}
                ...
                //       );
                //       router.push(`${item?.recordType?.toLowerCase()}-assessments/${item?.couseTrainingFileId}`)}}>
                //     <img loading="lazy"src={WebinarImg1} style={{ marginRight:5 }} />                
                //     </div>
                // </>
                )}
                  {item?.venueType}
