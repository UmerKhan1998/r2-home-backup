...
const TrackYourApplication = () => {
  ...
  const trackingId = getCookies("scholarshipTrackingId");
  ...
  const getDashboardTrackApplicatonFunc = async (token, code) => {
    try {
      ...
      const response = await endpoints.DashboardTrackApplicatonScholarship(
        token,
        code
      );
      if (response) {
  ...
  const rmsCourseTrainingRegistrationFeedbackFunc = async (
    ...
    try {
      const obj = {
        Image: image,
        RMSScholarshipRegistrationId: id,
        Feedback: feedback,
      };

      const response = await endpoints.RMSScholarshipRegistrationFeedback(
        token,
        obj
      );
      if (response) {
                  ...
                  <TrackApplicationCardDiv1>
                    ...
                    <CourseRow>
                      ...
                      <p className="course_name">
                        {dashboardTrackAppState?.firstName_EN}{" "}
                        {dashboardTrackAppState?.lastName_EN}
                      </p>
                    </CourseRow>
                  </TrackApplicationCardDiv1>
                </Col>
                {dashboardTrackAppState
                  ?.scholarshipDashboardApplicationTrackTimeLineViewModels
                  ?.length > 0 && (
                  <Col xl={12} lg={12} md={24} sm={24} xs={24}>
                    <TrackApplicationCardDiv2ActiveBtn>
                      ...
                      {dashboardTrackAppState?.scholarshipDashboardApplicationTrackTimeLineViewModels?.map(
                        (item, index) => (
                          <>
                            ...
                            <img loading="lazy"src={GreenLoader} height={20} width={20} />
                                ...
                                {item?.status === "ScholarshipAssignedToRMS" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "ScholarshipAssignedToManager" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "ScholarshipRejectByManager" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "ScholarshipAdditionalRequirementManager" && (
                                    <>
                                      <StyledTimeline mode={"left"}>
                                        <Timeline.Item
                                            key={index}
                                ...
                                {item?.status === "Approved" && (
                                 ...
                                 {item?.status === "Pendingapplicantdepartmentfeedback" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "Receivedapplicationcomplete" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "Pendingcredentialingdecision" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "PendingMedicalaffairsMOCdecision" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "Pendingfeedbackfromculturalmission" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "STCdecisioncomplete" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
                                ...
                                {item?.status === "ETSCdecisioncomplete" && (
                                  <StyledTimeline mode={"left"}>
                                    <Timeline.Item
                                      key={index}
                                      color={item?.statusColorNameValue}
