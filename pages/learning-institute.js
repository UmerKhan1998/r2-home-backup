...
const AssociateExecutiveAdministration = () => {
  ...
  const GetStaticPages = async () => {
    try {
      const response = await endpoints.GetStaticPages("learning-institute");
    ...
    try {
      const response = await endpoints.getAllRecord(
        ...
        "",
        {
          ...
          locationId: [],
          category: "",
          departmentSlug: "Learning Institute"
      }
      );
      if (response?.data?.statusCode === "200") {
                ...
                <div key={index}>
                  {data["type"] === "top_banner" && (
                    <div onClick={() => setDropdownCaretState(false)}>
                      <div>
                        {/* {console.log("skufsufsgfsayrfjas", data["content"])} */}
                        <Hero
                        ...
                        <Container>
                          <BreadcrumbDiv>
                            <Breadcrumb>
                              ...
                              <Breadcrumb.Item>Learning Institute</Breadcrumb.Item>
                            </Breadcrumb>
                          </BreadcrumbDiv>
                        </Container>
                      </MainBreadcrumbDiv>
