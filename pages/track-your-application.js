...
const TrackYourApplication = () => {
  ...
  //   dashboardTrackAppState?._UserDetailsViewModel
  // );
  //console.log("submitState", submitState);
  //console.log("loading", loading);

  // const screenFlag=getCookies('screenFlag')?getCookies('token'):getCookies('token1');
  ...
  useLayoutEffect(() => {
    AddPaymentFuncP(
      getCookies("token") ? getCookies("token") : getCookies("token1"),
      "",
      "BankDeposit",
  ...
  return (
    <div className="container">
      ...
      <body>
        <InvoiceModal
          openModal={modalInvoiceState}
          setOpenModal={setModalInvoiceState}
          content={modalInvoiceData?.invoiceNumber}
          data={modalInvoiceData}
          title={dashboardTrackAppState?.courseTrainingTitle_EN}
          recordType={dashboardTrackAppState?.courseTrainingRecordType_EN}
        />
                          ...
                          <>
                            {item?.status === "ForwardtoFinance" ? (
                                  ...
                                  <StyledTimeLineRow>
                                    <StyledcommentsDiv>
                                      ...
                                      <p className="Light">
                                        ...
                                        {dashboardTrackAppState?.courseTrainingRecordType_EN.toLowerCase()}{" "}
                                        has been approved and forward to
                                        finance, Please wait for payment link
                                      </p>
                                    </StyledcommentsDiv>
                                  </StyledTimeLineRow>
                                </Timeline.Item>
                              ...
                              <>
                                ...
                                {dropdownStatusState === "Online Payment" &&
                                  paymentResubmitState1 === item?.id && (
                                    <>
                                      {/* <StyledBoldP>
                                        * Please upload your payment receipt
                                      </StyledBoldP> */}
                                            ...
                                            goSell.config({
                                              ...
                                              transaction: {
                                                ...
                                                charge: {
                                                  ...
                                                  redirect: `${process.env.NEXT_PUBLIC_CLIENT_BASE_URL}/track-your-application`,
                                                  post: null,
                                                },
                                              },
                                            });
