                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab="Program Certificate" key="5">
                          <CertificateTab>
                            <p>
                              Get R2 Certificate by completing entire Program
                            </p>
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/program-assessments/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/program-surveys/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
