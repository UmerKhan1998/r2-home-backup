...
const EditTax = () => {
  ...
  const [getUserProfileDashboardState, setGetUserProfileDashboardState] =
    useState();
  //console.log("kjgfkdsjgfkudsf", getUserProfileDashboardState);

  // //console.log(
  //   "getUserProfileDashboardState",
  //   typeof getUserProfileDashboardState?.photoUrl
  // );

  const [selectItem, setSelectItem] = useState("manage-profile");
  ...
  const initialState = {
    ...
    bio: getUserProfileDashboardState
      ? getUserProfileDashboardState?.bioData_EN
      : "",
  ...
  const trackingIdVar = getCookies("trackingCode");
  ...
  const modifyProfileFunc = async (data) => {
    ...
    dispatch(
      userData({
        ...userDataReducer,
        photoUrl: imageUrl,
        firstName_EN: manageProfileState?.firstName_EN,
        lastName_EN: manageProfileState?.lastName_EN,
        bioData_EN: data?.bio,
  ...
  const courseInfoArr = [
    ...
    },
    {
      ...
      value: trackYourApplicationState?.courseTrainingRecordType_EN,
    },
    {
    ...
    {
      title: `${trackYourApplicationState?.courseTrainingRecordType_EN} Name`,
      value: trackYourApplicationState?.courseTrainingTitle_EN,
    },
    {
      title: `${trackYourApplicationState?.courseTrainingRecordType_EN}  Department`,
      value: trackYourApplicationState?.departmentName_EN,
    },
    {
      title: `${trackYourApplicationState?.courseTrainingRecordType_EN}  Duration`,
      value: trackYourApplicationState?.duration_EN,
    },
    {
  ...
  const createLMSUsersFunc = async (token, data) => {
    try {
      ...
      if(obj?.password.length >= 5 && obj?.oldPassword.length >= 5) {
        ...
        toast.error("you have to enter at least 5 digit!");
        setManageProfileState({...manageProfileState, 
          new_password: "", 
          current_password: ""
        })
  ...
  const filterTrue =
    trackYourApplicationState?.learnerDashboardApplicationTrackTimeLineViewModels?.some(
  ...
  const TabsArrayKey = ["Profile Info", "Track Application", "Change Password"];
  const TabsArray = [
                ...
                <Col xl={19} lg={19} md={19} sm={24} xs={24}>
                  <div style={{ width: "100%" }}>
                    <StyledInput
                      ...
                      name={"firstName_EN"}
                      maxLength={90}
                      value={manageProfileState?.firstName_EN}
                      onChange={manageProfileInputHandler}
                      placeholder={"First Name"}
                      // onClick={() => setFirstNameState(true)}
                    />
                    {manageProfileState?.firstName_EN === "" && (
                ...
                <Col xl={19} lg={19} md={19} sm={24} xs={24}>
                  <div style={{ width: "100%" }}>
                    <StyledInput
                      ...
                      name={"lastName_EN"}
                      maxLength={90}
                      value={manageProfileState?.lastName_EN}
                      onChange={manageProfileInputHandler}
                      placeholder={"Last Name"}
                      // onClick={() => setFirstNameState(true)}
                    />
                    {manageProfileState?.lastName_EN === "" && (
                      <StyledErrorP style={{ color: "#fa4947" }}>
                        This field is mandatory
                      </StyledErrorP>
                    )}
            ...
            <StyledMainDiv>
              <StyledFormInputRow>
                <StyledBioCol xl={2} lg={2} md={2} sm={24} xs={24}>
                  <div>
                    <p className="label">Your Bio:</p>
                    <p className="label-sub">Add a short introduction</p>
                  </div>
                </StyledBioCol>
              ...
              <Col xl={14} lg={14} md={24} sm={24} xs={24}>
                {pay_now ? (
                                      ...
                                      >
                                        <StyledTimeLineRow>
                                          <StyledcommentsDiv>
                                            ...
                                            <p className="Light">
                                              Congratulations! your course has
                  ...
                  <TrackApplicationCardDiv2>
                    <AdditionalInformationRow>
                      <h1>Application Tracking Timeline</h1>
                    </AdditionalInformationRow>
                      ...
                      {newPasswordValidationToggleState && (
                        <>
                          {manageProfileState?.new_password === undefined && (
                            <StyledErrorP>
                              {newPasswordValidationState==="Invalid Password"&&message_en}
                            </StyledErrorP>
                          )}
              ...
              >
                <StyledMainFilterRow gutter={[24, 24]}>
                  <StyledFilterRow gutter={[16, 16]}>
                    <Col span={24}>
                      <MainHeading>Manage Profile</MainHeading>
                    </Col>
                    <Col span={24}>
                      <CoursesTabs>
