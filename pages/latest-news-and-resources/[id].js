        ...
        <div onClick={() => setDropdownCaretState(false)}>
          <div>
              ...
              <Container>
                <BreadcrumbDiv>
                  <Breadcrumb>
                    ...
                    <Breadcrumb.Item>Latest News & Resources</Breadcrumb.Item>
                  </Breadcrumb>
                </BreadcrumbDiv>
              </Container>
            </MainBreadcrumbDiv>
            ...
            <Container>
              ...
              <div style={{ borderRadius: 55, padding: '0 10px' }} onClick={()=>window.open(`mailto:?subject=Share: ${getGetNewsAndResourcesGetByIdState?.title_EN}&body=Share: ${getGetNewsAndResourcesGetByIdState?.title_EN} ${window.location.href}`)}>
                        <FiMail color="#c71610" size={30} />
                    </div>
                      </StyledSocialLinksDiv>
                    </StyledSocialRow>{" "}
                    <StyledContentRow>
                      <h1>{getGetNewsAndResourcesGetByIdState?.title_EN}</h1>
                      <p>
                        {moment(
                    ...
                    <StyledBlogDiv>
                      <img
                        width={"100%"}
                        height={"100%"}
                        src={getGetNewsAndResourcesGetByIdState?.bannerImage_EN}
                      />
                    </StyledBlogDiv>
                  </StyledBlogMainDiv>
                  {parse(`${getGetNewsAndResourcesGetByIdState?.body_EN}`)}
                </Col>
                    ...
                    {getGetNewsAndResourcesTakeState?.map((item, index) => (
                      ...
                      >
                        ...
                        <StyledRecentlyPostInnerContentDiv>
                          ...
                          <p className="para">{item?.title_EN}</p>
                        </StyledRecentlyPostInnerContentDiv>
                      </StyledRecentlyPostInnerDiv>
                    ))}
                  </StyledRecentlyPostDiv>
                ...
                <StyledRecentlyPostDiv>
                  ...
                  {recentPostArr?.map((item, index) => (
                    <StyledRecentlyPostInnerDiv key={index}>
                      <img loading="lazy"alt={""} src={RecentPostImg} width={80} height={80} />
                      <StyledRecentlyPostInnerContentDiv>
