...
import { Check_your_email_phone_number_for_further_instructions_resetting_your_password, Confirm_New_Password, Create_a_New_Password, Enter_New_Password, Password_not_matched, Save_Password, Welcome_Lets_get_started, invalid_password, is_mandatory, password } from "../../src/helpers/LanguageConstant";
        ...
        <MainStyledSigninDiv dir="rtl">
          <Container>
            <StyledSigninDiv>
              <Row gutter={[32, 32]}>
                <Col span={12}>
                  <h1>{Create_a_New_Password}</h1>
                  <p>{Welcome_Lets_get_started}</p>
                  <StyledAlertBanner>
                    <p>{Check_your_email_phone_number_for_further_instructions_resetting_your_password}</p>
                  </StyledAlertBanner>
                  <>
                    <StyledInputPasswordRow>
                      ...
                      {(signUpState?.password !== signUpState?.confirm_password && signUpState?.confirm_password !== "" && signUpState?.password !== "") && (
                        <StyledErrorP>{Password_not_matched}</StyledErrorP>
                      )}
                    </StyledInputPasswordRow>
