...
const dashboard = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/programs");
                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab={Program_Certificate} key="5">
                          <CertificateTab>
                            <p>
                              {
                                Get_R2_Certificate_by_completing_the_entire_course
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/program-assessments/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/program-surveys/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
