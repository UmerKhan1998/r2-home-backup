...
import { CardImg, R2Favicon, Service } from "../../images";

import Header from "../../src/components/rtl/header";
import Footer from "../../src/components/rtl/footer";
import { home, privacy_policy } from "../../src/helpers/LanguageConstant";
...
const ServiceRequest = () => {
  ...
  const GetStaticPages = async () => {
    try {
      const response = await endpoints.GetStaticPages("complaint-and-suggestions-policy");
    ...
    <div className="container">
      ...
      <body>
        ...
        <div>
            <Hero 
              name={"privacy-policy"}
              title={GetStaticPagesState?.title_AR}
            />
          </div>
        {/* Breadcrumb */}
        <MainBreadcrumbDiv>
          <Container>
            <BreadcrumbDiv dir="rtl">
              <Breadcrumb>
                ...
                <Breadcrumb.Item>{GetStaticPagesState?.title_AR}</Breadcrumb.Item>
              </Breadcrumb>
            </BreadcrumbDiv>
          </Container>
        </MainBreadcrumbDiv>

     {GetStaticPagesState.content_AR && (
            <MainWhatWeofferingDivSection dir="rtl">
              <Container>{parse(GetStaticPagesState.content_AR)}</Container>
...
const MainWhatWeofferingDivSection = styled.div`
  h1 {
    font-family: "GESSTwoLight", snas-serif;
  }
  padding-block: 40px;
`;
