...
const EditTax = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/gamification");
          ...
          <body>
            <StyledDiv>
              ...
              >
                <Row gutter={[24, 24]}>
                  <Col span={24}>
                    <MainHeading>{My_Gamification}</MainHeading>
                  </Col>
                </Row>
                      ...
                      <Row gutter={[12, 12]}>
                        <Col span={24}>
                          <StyledBadgesLevelRow>
                            <h2>
                              {" "}
                              <b>{Badges_and_Levels_Statistics}</b>{" "}
                            </h2>
                          </StyledBadgesLevelRow>
                        </Col>
                        <Col span={24}>
