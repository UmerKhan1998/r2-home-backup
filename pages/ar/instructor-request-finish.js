...
import { thank_you_so_much_for_submitting_request, track_your_request, Your_Request_has_been_submitted, Your_Request_has_been_submitted_for_Certificate, your_tracking_number_has_been_sent_to_your_email } from "../../src/helpers/LanguageConstant";
          ...
          <MainWhatWeofferingDivSection>
            <Container>
              <WhatWeofferingDivSection>
                <h1>{Your_Request_has_been_submitted}</h1>
                <img loading="lazy"alt={""} height={80} width={80} src={RequestSubmissionImg} />
                {/* <img loading="lazy"src={RequestSubmissionImg} /> */}
                <h2>{thank_you_so_much_for_submitting_request}</h2>
                <p>{your_tracking_number_has_been_sent_to_your_email}</p>
                <LinkDiv>
                  <LinkP
                    onClick={() =>
                      router.push("/ar/instructor-track-application")
                    }
                  >
                    {track_your_request}
                  </LinkP>
