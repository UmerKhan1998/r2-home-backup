...
import CertificatesCardsComp from "../../src/components/rtl/Cards/CertificatesCards";
...
const dashboard = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/learning-transcript");
        ...
        <div className="container">
          ...
          <body>
            ...
            >
              <Row gutter={[15, 15]}>
                <Col span={24}>
                  <MainHeading>{Learning_Transcript}</MainHeading>
                </Col>
                <Col span={24}>
                  <CourseFilterSearch>
                    <Row gutter={12}>
                          ...
                          {item.courseTrainingTitle_AR &&
                            item.courseTrainingTitle_AR
                              ...
                              <CertificatesCardsComp
                                title={item?.courseTrainingTitle_AR}
                                issueDate={item?.issueDate}
                                departmentName={item?.departmentName_AR}
