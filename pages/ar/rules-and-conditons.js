...
import { Rules_and_conditions, home } from "../../src/helpers/LanguageConstant";
...
const ServiceRequest = () => {
  ...
  const GetStaticPages = async () => {
    try {
      const response = await endpoints.GetStaticPages("rules-and-conditons");
          ...
          <Container>
            <BreadcrumbDiv dir="rtl">
              <Breadcrumb>
                ...
                <Breadcrumb.Item>{Rules_and_conditions}</Breadcrumb.Item>
              </Breadcrumb>
            </BreadcrumbDiv>
          </Container>
        </MainBreadcrumbDiv>
