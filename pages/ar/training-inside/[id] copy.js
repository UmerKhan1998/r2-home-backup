...
const dashboard = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/training");
                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab={Training_Certificate} key="5">
                          <CertificateTab>
                            <p>
                              {
                                Get_R2_Certificate_by_completing_the_entire_course
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/training-assessments/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/training-surveys/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
