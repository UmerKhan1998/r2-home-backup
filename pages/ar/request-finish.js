...
import {
  request_submitted_para,
  thank_you_submitting_request,
  tracking_number_sent_your_email,
  track_your_request,
        ...
        <MainWhatWeofferingDivSection>
          <Container>
            <WhatWeofferingDivSection>
              ...
              <img loading="lazy"alt={""} height={140} width={140} src={RequestSubmissionImg} />
              {/* <img loading="lazy"src={RequestSubmissionImg} /> */}
              <h2>{thank_you_submitting_request}</h2>
              <p>{tracking_number_sent_your_email}</p>
              <LinkDiv>
                <LinkP onClick={() => router.push("/ar/track-application")}>
                  {track_your_request}
                </LinkP>
              </LinkDiv>
            </WhatWeofferingDivSection>
