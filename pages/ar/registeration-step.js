...
const RegisterationStep = () => {
  ...
  const [mandatoryRadioFieldState, setMandatoryRadioFieldState] =
    useState(false);
    const [telephoneValidationState, setTelephoneValidationState] = useState(false);
  ...
  const [ccEmployeeIndex, setCcEmployeeIndex] = useState(getCookies('ccEmployeeIndexCookies'));
  ...
  useLayoutEffect(() => {
    ...
    const presistVariable =
      getCourseDetailId &&
      getCourseDetailId[step]?.lovServicesCourseTrainingCheckListViewModels[ccEmployeeIndex]
        ?.value_EN;
  ...
  const disabledTrainingEndDate = (current) => {
    ...
    const [emailDynamicValidationState,setEmailDynamicValidationState]=useState([])
  ...
  const [telValidateState,setTelValidateState]=useState([])
    ...
    useLayoutEffect(()=>{
      setEmailDynamicValidationState(registerCourseTrainingEditState?.filter(item=>item?.fieldSubType==="email"))

      setTelValidateState(registerCourseTrainingEditState?.filter(item=>item?.fieldSubType==="tel"))
        ...
        <div onClick={() => setDropdownCaretState(false)}>
          ...
          {dashboardState ? (
            ...
            <>
              <MainStyledSigninDiv>
                <StyledSigninDiv>
                  <StyledRegisterationRow dir="rtl">
                                    ...
                                    <Col key={innerIndex} span={24}>
                                      ...
                                      {item?.fieldSubType === "tel" && (
                                        <>
                                         ...
                                         {telValidateState?.find(item=>item?.fieldSubType==="tel")?.value_EN?.length ===0?
                                          <StyledErrorP
                                          style={{ color: "#fa4947" }}
                                          >
                                                {this_field_is_mandatory}
                                              ...
                                              :
                                              <>
                                              {telephoneValidationState&&emailDynamicValidationState?.reduce((acc, curr)=>{
                                                if (curr.validation !== "Invalid Email") {
                                                  return acc + 1;
                          }
                          return acc
                        } 
                        , 0)=== emailDynamicValidationState?.length &&
                        telValidateState?.reduce((acc, curr)=>{
                              if (curr.value_EN?.length >=9 ) {
                                return acc + 1;
                              }
                              return acc
                            } 
                            , 0)!==telValidateState?.length&&
                            <StyledErrorP
                            style={{ color: "#fa4947" }}
                          >
                            {invalid_number}
                                      ...
                                      {item?.fieldSubType === "email" && (
                                        <>
                                              ...
                                              <StyledInput
                                                ...
                                                if (!myArray.includes(item?.checkListDetailId)) {
                                                  setMyArray(prevArray => [...prevArray, item?.checkListDetailId]);
                                                }
                                                }
                                                }
                                                onBlur={() =>{
                                                ...
                                                onChange={(e) => {
                                                  ...
                                                  setEmailDynamicValidationIdState(item?.checkListDetailId)
                                                  emailValidationInputHandler(e, innerIndex, "input")

                                                  const index = myArray.indexOf(item?.checkListDetailId);
                                                  if(index!==-1 && emailDynamicValidationState?.find(dItem=>myArray.includes(dItem?.checkListDetailId))?.validation!=="Invalid Email"){
                                              ...
                                              />
{(
myArray?.includes(item?.checkListDetailId)&&emailValidation(registerCourseTrainingEditState[
  innerIndex
]?.value_EN)!==undefined)&&
<>
...
{/* {item?.required === true &&
                                            ...
                                            {item?.options_EN?.map(
                                              (item1, index) => (
                                                <div key={index}>
                                                  ...
                                                  />
                                                  <label style={{ marginRight:5 }} htmlFor="vehicle1">
                                                    {parse(item1)}
                                                  </label>
                                                </div>
                                              )
                                          ...
                                          <>
                                            ...
                                            <StyledRadioButtonDiv>
                                              <Radio.Group
                                                ...
                                                // defaultvalue={item?.value_AR!==null?item?.value_AR:item?.value_EN}
                                              >
                                                {item?.options_AR?.length === 0
                                                  ? item?.options_EN?.map(
                                                      (item, index) => (
                                          ...
                                          <StyledRadioButtonDiv>
                                            <Radio.Group
                                              ...
                                              onChange={(e) => {
                                                ...
                                                setCookies('ccEmployeeIndexCookies',innerIndex);
                                             {(e?.target?.value === "No"||  e?.target?.value === "لا")
                                                  ? (inputHandler(
                                                      "",
                                                      innerIndex + 1,
                                                      "radio"
                                             ...
                                             {(e?.target?.value === "Yes"||  e?.target?.value === "نعم")
                                          ...
                                          "Invalid Email" ? (
                                            <>
                                              ...
                                              <StyledInput
                                                ...
                                                registerCourseTrainingEditState[
                                                  innerIndex
                                                ]?.value_AR!==null?registerCourseTrainingEditState[
                                                  innerIndex
                                                ]?.value_AR:registerCourseTrainingEditState[
                                                  innerIndex
                                                ]?.value_EN
                                              }
                                              />
                                      ...
                                      {item?.fieldSubType === "text" &&
                                        item?.fieldType === "CCEEmployeeId" && (
                                          <>
                                            {(ccEmployeeValue ==="Yes"||ccEmployeeValue=="نعم") ? (
                                              <>
                                                {item?.required === true ? (
                                                  <StyledFlexLabelDiv>
                                                    <RequiredP>*</RequiredP>
              ...
              <SignInRow dir="rtl">
                <NextContainer>
                  <SpaceBetweenDiv>
                    ...
                    (employeeIdState === "200" || employeeIdState === "202"||employeeIdState !== "404") &&
  emailDynamicValidationState?.reduce((acc, curr)=>{
    if (curr.validation !== "Invalid Email" && curr.required===true) {
      return acc + 1;
    }
    return acc
  }
  , 0)=== emailDynamicValidationState?.reduce((acc, curr)=>{
  ...
  telValidateState?.reduce((acc, curr)=>{
    if (curr.value_EN?.length >=9 && curr.required===true) {
      return acc + 1;
    }
    return acc
  }
