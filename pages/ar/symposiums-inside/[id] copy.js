...
const dashboard = () => {
    ...
    try {
      if (courseId) {
        ...
        if (response.data.statusCode === "200") {
          ...
          if (courseVideoState == "") {
            setCourseVideoState(response?.data?.data?.demoVideo_AR);
          }
        }
      }
    } catch (error) {
  ...
  const getMinute = (items) => {
    var totalMinutes = 0;
    items.map((item, index) => (totalMinutes += parseInt(item?.duration_AR)));
  ...
  return (
    <>
      {isAuthorized ? (
              ...
              >
                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab={Reviews} key="3">
                          <CourseReview>
                            ...
                            <StyledInput
                              ...
                              suffix={<img width="25px" src={SearchBgIcon} />}
                              onChange={(e) => {
                                setReviewParams({
                                  ...reviewParams,
                                      ...
                                      <div className="review-card-text">
                                        ...
                                        <div className="review-helpful">
                                          ...
                                          <div>
                                            ...
                                            {/* {item?.favourite === "True" && (<>
                                              <a>
                                                <img src={LikeThumbFill} width="27px" />
                                              </a>
                                              <a>
                                                <img
                                                  style={{
                        ...
                        <Tabs.TabPane tab={Discussion_Board} key="4">
                          <DiscussionBoard>
                            <>
                              {/* <StyledInput
                              placeholder="Search"
                              ...
                              <div className="discussion-comment-input">
                                ...
                                <div className="discussion-input">
                                  <input
                                    ...
                                    value={
                                      addDiscussionParamsState?.discussion_AR
                                    }
                                    onChange={(e) => {
                                      setAddDiscussionParamsState({
                                        ...addDiscussionParamsState,
                        ...
                        <Tabs.TabPane tab={Symposiums_Certificate} key="5">
                          <CertificateTab>
                            <p>
                              {
                                Get_R2_Certificate_by_completing_the_entire_course
                      ...
                      {courseCurriculumState === undefined ? (
                        <>
                          <div className="dataLoader">
                            <Image src={Rolling} width="40px" height="40px" />
                          </div>
                        </>
                      ) : (
                        <>
                                ...
                                <div className="curriculum-module-head">
                                  ...
                                  <div className="module-total">
                                    ...
                                    {item?.dashboardInsideFileViewModels
                                      ...
                                      <>
                                        <span>
                                          <img src={courseClock} width="15px" />
                                          {getMinute(
                                            item?.dashboardInsideFileViewModels
                                          )}
                                        </span>
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/course-assessments/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/ar/course-surveys/${item?.assessmentId_AR}`
                                                  );
                                                }}
                                              >
                                                {item?.title_AR}
                                        ...
                                        {item?.fileTypeRecord === "Scorm" && (
                                          <div
                                            ...
                                            onClick={(e) => {
                                              ...
                                              window.open(
                                                `${item?.url_AR}?userID=112127&HASH=JHGG`
                                              );
                                            }}
                                          >
                                            <h4>{item?.title_AR}</h4>
                ...
                >
                  <div className="time-out-modal">
                    ...
                    />
                    <p>
                      {Your_zoom_class_will_start_at} <br />{" "}
        ...
        <>
          <img className="pre-loader" src={Preloader.src} />
        </>
      )}
    </>
  );
