...
import {
  back,
  next,
  Please_take_this_survey_about_your_experience_in_this,
  Submit,
  Your_Survey_has_been_Submitted,
  Thank_you_so_much_for_submitting_the_survey,
                  ...
                  {SurveySubmited === false ? (
                        ...
                        {getDashboardInsideSurveyState?.statusCode === "404" ? (
                          ...
                          <>
                            <h2 className="survey-title">
                              {getDashboardInsideSurveyState?.name_AR ===
                              undefined ? (
                    ...
                    <SurveysSection>
                      <div className="submited">
                        <div>
                          <h1>{Your_Survey_has_been_Submitted}</h1>
                          <img
                            src={Submited?.src}
                            width="100px"
                            height="100px"
                          />
                          <p>{Thank_you_so_much_for_submitting_the_survey}</p>
                          <CustomButton
                            customStyle={{
                              paddingInline: "30px",
                              borderColor: "#105F43",
