...
import {
  confirm,
  let_track_your_application,
  let_track_your_application_para,
  let_track_your_scholarship_application,
  please_provide_your_scholarship_tracking,
      ...
      if (code) {
        ...
        if (response) {
          if (response?.data?.message !== "Invalid Tracking Number") {
            router.push(`/ar/scholarship-authentication/${code}`);
          } else {
              ...
              <StyledSigninDiv>
                <Row dir="rtl" gutter={[32, 32]}>
                  <Col xl={12} lg={12} md={12} sm={24} xs={24}>
                    <h1>{let_track_your_scholarship_application}</h1>
                    {/* <p>{let_track_your_application_para}</p> */}

                    <>
                      <Row>
                        <p>
                          <b># {please_provide_your_scholarship_tracking}</b>
                        </p>
                        <StyledInput
                          type="text"
                          name={"emailOrPhone"}
              ...
              {timerCounter === 0 && signUpState?.emailOrPhone?.trim()?.length > 0 ? (
                <CustomButton
                  ...
                  onClick={() => {
                    ...
                    setCookies("trackingCode", signUpState?.emailOrPhone);
