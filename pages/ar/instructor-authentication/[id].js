...
const PersonalInformation = () => {
  ...
  const handleInputChange = (e) => {
    ...
    //   createLMSAuthorizationFunc(router.asPath?.split("/")[3], e);
    // }
  };
            ...
            <Container>
              <StyledSigninDiv1>
                <StyledRegisterationRow gutter={[32, 32]}>
                  <Col span={24}>
                    <h1>نود التحقق من رقم هاتفك المحمول</h1>
                    <BeforeFormP>
                      الرجاء إدخال الرمز المكون من 6 أرقام المرسل إلى رقم هاتفك
                      المحمول
                    </BeforeFormP>
                    ...
                    <SecurityNoteP>
                      الرجاء إدخال رمز الأمان الخاص بك
                    </SecurityNoteP>
