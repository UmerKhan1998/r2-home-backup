...
const CourseLandingPage = () => {
  ...
  useLayoutEffect(()=>{
    if(getCookies("programFilterCategory")) {
      setLocationState(getCookies("programFilterCategory"))
    }
  }, [getCookies("programFilterCategory")])
  ...
  const GetStaticPages = async () => {
    setHeroLoading(true);
    try {
      const response = await endpoints.GetStaticPages("programs-landing-page");
            ...
            <Head1Section>
              <Row dir="rtl">
                ...
                <Head1SectionDiv>
                  {totalRecord && (
                    <p>
                      {showing} 1–{totalRecord} {of} {totalRecord} {programs}
                    </p>
                  )}
                </Head1SectionDiv>
                {/* <StyledDivider /> */}
