...
import { Technical_support_policy, home } from "../../src/helpers/LanguageConstant";
...
const ServiceRequest = () => {
  ...
  const GetStaticPages = async () => {
    try {
      const response = await endpoints.GetStaticPages("tachnical-support-policy");
          ...
          <Container>
            <BreadcrumbDiv dir="rtl">
              <Breadcrumb>
                ...
                <Breadcrumb.Item>{Technical_support_policy}</Breadcrumb.Item>
              </Breadcrumb>
            </BreadcrumbDiv>
          </Container>
        </MainBreadcrumbDiv>
