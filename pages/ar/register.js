...
import {
  cancel,
  continue_your_application,
  courses,
  for_lan,
  fourDigitCode,
  modify_your_skills_by_registering_with_us,
  or,
  programs,
  register,
  register_para,
                ...
                <StyledSigninDiv>
                  <Row dir="rtl" gutter={[32, 32]}>
                    <Col
                      ...
                      xs={24}
                    >
                      <h1>{modify_your_skills_by_registering_with_us}</h1>
                      <p>{register_para}</p>
                      <Row gutter={[24, 24]}>
                      ...
                      <StyledColoredPFlex1>
                        ...
                        <StyledResendOTPColoredP
                          onClick={() => router.push(`/ar/track-application`)}
                        >
                          {continue_your_application}
                        </StyledResendOTPColoredP>
                      </StyledColoredPFlex1>
                    </Col>
                    <StyledSignInImgCol xl={12} lg={12} md={24} sm={24} xs={24}>
                      <Image alt={""} height={1000} width={380} src={KhatoonImg} />
                    </StyledSignInImgCol>
                  </Row>
                </StyledSigninDiv>
              </Container>
