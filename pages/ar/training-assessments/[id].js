...
import {
  Time_left,
  min,
  Please_take_this_Assessment_about_your_experience_in_this,
  Points,
  Drag_drop_files_here,
  Or_browse_on_your_computer,
  Submit,
  Attempt,
  Submit_your_Assessment,
  Start_Assessment,
  Receive_Grade,
  To_Pass,
  or_higher,
  Sorry_you_have_run_out_of_time_please_attempt_again_in_the_given_time,
  Questions_Remaining_Do_you_still_want_to_Submit,
  No,
  Your_Grade,
  Yes,
  Unlimited,
  ...
  Please_Select_the_correct_file_format,
...
const dashboard = () => {
  ...
  const AddAssessmentAnswerFunc = async () => {
    try {
      ...
      if (response.data.statusCode === "200") {
        toast.success(Assessment_Answer_Submitted);
  ...
  function startTimer() {
    ...
    if (m < getDashboardInsideAssessmentState?.duration_AR / 2) {
      setTimeAlert(true);
    }
  ...
  useLayoutEffect(() => {
    setAssessmentTimeEl(`${getDashboardInsideAssessmentState?.duration_AR}:00`);
  }, [getDashboardInsideAssessmentState?.duration_AR]);
  useLayoutEffect(() => {
                  ...
                  {startAssessmentState ? (
                    <SurveysSection>
                      <h2 className="survey-title">
                        {getDashboardInsideAssessmentState?.name_AR ===
                        undefined ? (
                        ...
                        <Col span={24}>
                          <EmptyData>
                            <Empty
                              ...
                              description={No_Questions_Found}
                            />
                          </EmptyData>
                        </Col>
                      ) : (
                                ...
                                {item?.fieldType === "Radio" && (
                                  <div className="surveys-quastion" key={qaId}>
                                    <div className="quastion-head">
                                      <h4>
                                        *{getIndex(qaId)}. {item?.question_AR}
                                      </h4>
                                    </div>
                                    <div
                                    ...
                                    <div className="quastion-body">
                                      <AnsArea
                                        ...
                                        onChange={(e) => {
                                          ...
                                          obj.answer_AR = e.target.value;
                                          obj.markCorrect =
                                            obj.answer_AR === "" ? false : true;
                                          Arr.dashboardInsideAssessmentQuestionViewModels[
                                            qaId
                                          ].dashboardInsideAssessmentAnswerViewModels[0] =
                                            obj;
                    ...
                    <AssessSection>
                      {(GetDashboardInsideSurveyLoader) ? (
                        ...
                        <h2 className="survey-title">
                          {getDashboardInsideAssessmentState?.name_AR}{" "}
                          <span>{Assessment_Submissions}</span>
                        </h2>
                        <p className="desc">
                          <div className="times">
                            <span className="left">{Assessments}</span>
                            <span className="total">
                              <img loading="lazy"src={courseClock} width="15px" />{" "}
                              {getDashboardInsideAssessmentState?.duration_AR}{" "}
                              {min}
                        ...
                        <AssessGrad>
                          <div className="grad-head">
                            <span>{Submit_your_Assessment}</span>
                                ...
                                getDashboardInsideAssessmentState?.obtainedPassingType ===
                                  ...
                                  <CustomButton
                                    onClick={() => {
                                      ...
                                      setAssessmentTimeEl(
                                        `${getDashboardInsideAssessmentState?.duration_AR}:00`
                                      );
                                    }}
                                    customStyle={{
                                      backgroundColor: "#105F43",
                          ...
                          <div className="grad-body">
                            ...
                            <div className="your-grad">
                              <span>{Your_Grade}</span>
                              <span className="grad-box">
                                {getDashboardInsideAssessmentState?.obtainedPassingType ===
                                ""
                                  ? "--"
                                  : getDashboardInsideAssessmentState?.obtainedPassingType==="Inprogress"? Inprogress: getDashboardInsideAssessmentState?.obtainedPassingType==="Pass"?pass:fail
                                }
                              </span>
                            </div>
                          </div>
