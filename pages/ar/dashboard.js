...
import {
  ...
  Sort_by,
  Achievements,
  You_have_nothing_scheduled_for_today,
  Looks_like_you_are_free,
  new_i,
  Ok_text,
...
const dashboard = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/dashboard");
                ...
                <Col span={24} xl={14}>
                  <DashboardWelcomeDiv>
                    <div>
                      <p>
                        {getGreetingTime()},{" "}
                        {getDashboardMasterState?.userName_AR}
                      </p>
                      <h2>
                        {" "}
                        {Welcome_to} {getDashboardMasterState?.companyName_AR}{" "}
                      </h2>
                    </div>
                    <div>
                ...
                <Col span={24} sm={12} xl={5}>
                  <DashboardIconColumnCard>
                    ...
                    <div>
                      ...
                      <h2>
                        {getDashboardMasterState?.recentAchievement_AR === "" ||
                        getDashboardMasterState?.recentAchievement_AR ===
                          undefined
                          ? Achievements
                          : getDashboardMasterState?.recentAchievement_AR}
                      </h2>
                      <p>{Recent_Achievement}</p>
                    </div>
                  </DashboardIconColumnCard>
                </Col>
                <Col span={24} sm={12} xl={5}>
                ...
                <Col span={24} lg={13}>
                  <Noticeboard>
                    <div className="noticeboard-header">
                      <h2>{Noticeboard_ar}</h2>
                      <StyledSelect className="sort-by" defaultValue={Sort_by}>
                    ...
                    <div className="todayschedule">
                      ...
                      {scheduleCalendarState?.length === 0 && (
                        <EmptySchedule>
                          ...
                          />
                          <p>
                            {You_have_nothing_scheduled_for_today}, <br />{" "}
                            {Looks_like_you_are_free}
                          </p>
                        </EmptySchedule>
                      )}
                      <Row gutter={10}>
                        {scheduleCalendarState?.map((item, index) => (
                          <>
                            {index <= 2 && (
                              <Col span={24} lg={24} md={12} key={index}>
                                        ...
                                        <StyledCourseScheduledInnerDiv>
                                          <div className="schedule-info">
                                            ...
                                            <div className="schedule-txt">
                                              <h2>{item?.venueName_AR}</h2>
                                              <p>
                                                {item?.venueLocation_AR} -{" "}
                                                {Due_Date}:{" "}
                                                {moment
                                                  .utc(item?.dueDate)
                                                  .local()
                      ...
                      <StyledViewAllDiv>
                        {scheduleCalendarState?.length >= 2 && (
                          <StyledViewScheduledButton1>
                            <Link href="my-schedule">{View_All}</Link>
                            <AiOutlineLeft style={{ fontSize: "10px" }} />
                          </StyledViewScheduledButton1>
                        )}
                      </StyledViewAllDiv>
                    </div>
