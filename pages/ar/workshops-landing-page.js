...
const CourseLandingPage = () => {
  ...
  const GetStaticPages = async () => {
    setHeroLoading(true);
    try {
      const response = await endpoints.GetStaticPages("workshops-landing-page");
            ...
            <Head1Section>
              <Row dir="rtl">
                ...
                <Head1SectionDiv>
                  {totalRecord && (
                    <p>
                      {showing} 1–{totalRecord} {of} {totalRecord} {workshops}
                    </p>
                  )}
                  {/* <Select
