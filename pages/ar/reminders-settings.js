...
const EditTax = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/reminders-settings");
  ...
  const reminderSettingStateHead = ["S.No", Subject, Message, Date_Time];
      ...
      {isAuthorized ? (
        <div className="container">
          ...
          <StyledModal
            ...
            width={480}
          >
            <StyledInputBoxContainer dir="rtl">
              ...
              <div className="input-container">
                ...
                <StyledDatePicker
                  placeholder={Reminder_Date_Time}
                  showTime
            ...
            <div style={{ textAlign: "left", display:"flex", justifyContent:"start" }}>
            {addLoading?
                <CustomButton
                  customStyle={{
                    height: "35px",
