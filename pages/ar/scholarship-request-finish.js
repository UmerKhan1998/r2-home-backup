...
import { request_submitted_para, thank_you_submitting_request, tracking_number_sent_your_email, track_your_request } from "../../src/helpers/LanguageConstant";
        ...
        <div onClick={() => setDropdownCaretState(false)}>
          ...
          <MainWhatWeofferingDivSection>
            <Container>
              ...
              <h1>{request_submitted_para}</h1>
                <img loading="lazy"alt={""} height={80} width={80} src={RequestSubmissionImg} />
                {/* <img loading="lazy"src={RequestSubmissionImg} /> */}
                <h2>{thank_you_submitting_request}</h2>
              <p>{tracking_number_sent_your_email}</p>
                <LinkDiv>
                  <LinkP
                    onClick={() => router.push("/ar/scholarship-track-application")}
                  >
                  {track_your_request}
                  </LinkP>
                </LinkDiv>
