...
const CourseLandingPage = () => {
  ...
  const GetStaticPages = async () => {
    setHeroLoading(true);
    try {
      const response = await endpoints.GetStaticPages("conferences-landing-page");
            ...
            <Container>
              <BreadcrumbDiv>
                <Breadcrumb dir={"rtl"}>
                  ...
                  <Breadcrumb.Item>{conferences}</Breadcrumb.Item>
                </Breadcrumb>
              </BreadcrumbDiv>
            </Container>
          </MainBreadcrumbDiv>
            ...
            <Head1Section>
              <Row dir="rtl">
                ...
                <Head1SectionDiv>
                  {totalRecord && (
                    <p>
                      {showing} 1–{totalRecord} {of} {totalRecord} {conferences}
                    </p>
                  )}
                  {/* <Select
