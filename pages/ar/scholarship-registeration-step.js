...
const RegisterationStep = () => {
  ...
  //console.log('stateApproved',stateApproved)
  ...
  //console.log("registerationDashboardStep", registerationDashboardStep);
  ...
  useLayoutEffect(() => {
    ...
    const presistVariable =
      getCourseDetailId[1]?.lovServicesScholarshipCheckListViewModels[0]
        ?.value_EN;
    ...
    try {
      if (id || token) {
        ...
        if (response) {
          ...
          //console.log("ScholarResponse", response?.data?.data?.scholarshipRegistrationCode);
          setCookies(
          ...
          if (specificIndex1 >= 0) {
            ...
            //console.log("userDataReducer?.firstname_AR", firstName);
          ...
          //console.log("responseTesting", dataUk);
  ...
  //console.log("checkListCategoryId", checkListCategoryId);

  const [trackingIdState, setTrackingIdState] = useState("");

  //console.log("stepLoadingState", stepLoadingState, createLoading);
  ...
  const GetCountryLovFunc = async (token) => {
    ...
    try {
      if (token) {
        const response = await endpoints.GetCountryLov(token);
        if (response) {
                ...
                <SignInRow>
                  <NextContainer>
                    <SpaceBetweenDiv>
                      ...
                      employeeIdState === "200" &&
                      emailValidationState !== "Invalid Email"&&phoneValidation>0!==false ? (
                        <>
                          {stepLoadingState ? (
                            <CustomButton
                              customStyle={{
                            ...
                            <CustomButton
                              ...
                              onClick={() => {
                                ...
                                if (step + 1 === getCourseDetailId.length) {
                                  router.push("/ar/scholarship-request-finish");
                                }
