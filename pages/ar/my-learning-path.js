...
import {
  ...
  Start_Date,
  Required_Badge,
  You_must_earn_this_badge_to_complete_this_step,
  InCompleted,
  Completed,
  All,
...
const dashboard = () => {
  ...
  const [selectItem, setSelectItem] = useState("/ar/my-learning-path");
                  ...
                  <MainHeading>
                    ...
                    >
                      ...
                      {GetAllCourseTrainingRegistrationByLMSUserIdState?.map((item, index)=>(
                        <Option value={item?.recordType_EN} key={index}>{item?.recordType_AR}</Option>
                      ))}
                    </StyledSelect>
                  </MainHeading>
                </Col>
                                        ...
                                        <>
                                          ...
                                          >
                                            ...
                                            <div className="module-card">
                                              ...
                                              <div>
                                                <h4>{item?.sectionTitle_AR}</h4>
                                                <span>
                                                  {item?.sectionDescription_AR}
                                                </span>
                                              </div>
                                            </div>
                                          </div>
                  ...
                  <LearningModule>
                    ...
                    undefined ? (
                      ...
                      <>
                        ...
                        <h3>{getDashboardLearningPathSingleState?.title_AR}</h3>
                        <div
