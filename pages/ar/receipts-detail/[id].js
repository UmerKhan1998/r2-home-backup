...
import {
  ...
  Amount,
  Total_Paid,
  If_you_have_any_questions_about_this_receipt_please_contact_our,
  support_team,
  Transaction_ID,
  Receipt,
  Bank_Deposit,
            ...
            <body>
              ...
              >
                <Row gutter={[15, 15]}>
                  ...
                  <Col span={24}>
                    <PaymentReceipts ref={PaymentReceiptsHTML} dir="rtl">
                      ...
                      <div className="receipts-detail-header">
                        <div>
                          <div className="course-name">
                            {dashboardReceiptDetail?.companyName_AR}
                          </div>
                          <div className="course-desc">
                            {dashboardReceiptDetail?.companyAddress_AR}
                          </div>
                        </div>
                      ...
                      <div className="receipts-detail-sendto">
                        <span>{Sold_to}:</span>{" "}
                        {dashboardReceiptDetail?.lmsUserName_AR}
                      </div>
                          ...
                          <table>
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  {
                                    dashboardReceiptDetail?.courseTrainingTitle_AR
                                  }{" "}
                                  ({dashboardReceiptDetail?.departmentName_AR})
                                </td>
                                <td>
                                  {moment(
                                ...
                                <td>01</td>
                                <td>
                                  {sar} {dashboardReceiptDetail?.price}
                                </td>
                                <td>
                                  {sar} {dashboardReceiptDetail?.discountValue}
                                </td>
                                <td>
                                  {sar} {dashboardReceiptDetail?.vatValue}
                                </td>
                                <td>
                                  {sar} {dashboardReceiptDetail?.netPrice}
                                </td>
                              </tr>
                              <tr>
                                <td></td>
                      ...
                      <div className="receipts-detail-footer">
                        <p>
                          ...
                          <a href="/ar/contact" target="_blank">{support_team}</a>
                        </p>
                      </div>
                    </PaymentReceipts>
                  </Col>
