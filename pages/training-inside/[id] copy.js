                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab="Training Certificate" key="5">
                          <CertificateTab>
                            <p>
                              Get R2 Certificate by completing entire Training
                            </p>
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/training-assessments/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/training-surveys/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
