                  ...
                  <Col span={24} lg={15}>
                    <CourseInsideDetail>
                      ...
                      <CoursesTabs defaultActiveKey={checkActivetab()}>
                        ...
                        <Tabs.TabPane tab="Conference Certificate" key="5">
                          <CertificateTab>
                            <p>
                              Get R2 Certificate by completing entire Conference
                            </p>
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/conference-assessments/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
                                            ...
                                            <h4>
                                              <span
                                                onClick={() => {
                                                  ...
                                                  router.push(
                                                    `/conference-surveys/${item?.assessmentId_EN}`
                                                  );
                                                }}
                                              >
                                                {item?.title_EN}
