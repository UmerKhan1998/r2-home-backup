...
import InvoiceModal from "../src/components/Modal/InvoiceModal";
...
// console.log('dashboardTrackAppState',dashboardTrackAppState?.registrationId)
  ...
  const getDashboardTrackApplicatonFunc = async (token, code) => {
    try {
      //console.log('token, code',token, code);
  ...
  const AddPaymentFuncP = async (token, image, paymentMethod, amount, id, TransactionId,OnlinePaymentStatus) => {
...
const filterTrueInvPending =
  ...
  <body>
    <InvoiceModal openModal={modalInvoiceState} setOpenModal={setModalInvoiceState} content={modalInvoiceData?.invoiceNumber} data={modalInvoiceData} title={dashboardTrackAppState?.courseTrainingTitle_EN} recordType={dashboardTrackAppState?.courseTrainingRecordType_EN}/>

    <Header />

    <SideDesignDiv>
      {/* <img src={SideDesign} /> */}
      <Image height={500} width={500} src={SideDesign} />
    </SideDesignDiv>
    ...
    <MainWhatWeofferingDivSection>
      <Container>
        <WhatWeofferingDivSection>
          ...
          <p className="tracking_no">Tracking # {trackingId} </p>
          <Row gutter={[32, 32]}>
            <Col xl={12} lg={12} md={24} sm={24} xs={24}>
              <TrackApplicationCardDiv1>
                <ApplicationStatusRow>
                  <h1>
                    {dashboardTrackAppState?.courseTrainingRecordType_EN}{" "}
                    Information
                  </h1>
                </ApplicationStatusRow>
                <CourseRow>
                  ...
                  <p className="course_name">
                    {dashboardTrackAppState?.courseTrainingTitle_EN}
                  </p>
                </CourseRow>
                <CourseRow>
                  <p className="label">
                  ...
                  <p className="course_name">
                    {dashboardTrackAppState?.departmentName_EN}
                  </p>
                </CourseRow>
                <CourseRow>
                  <p className="label">
                  ...
                  <p className="course_name">
                    {dashboardTrackAppState?.duration_EN}
                  </p>
                </CourseRow>
                <CourseRow>
                            ...
                            >
                              <StyledTimeLineRow>
                                <StyledcommentsDiv>
                                  ...
                                  <p className="Light">
                                    Congratulations! your {dashboardTrackAppState?.courseTrainingRecordType_EN.toLowerCase()}{" "} has
                                    been approved and forward to finance,
                                    Please wait for payment link
                                  </p>
                                </StyledcommentsDiv>
                              </StyledTimeLineRow>
                            </Timeline.Item>
                                    ...
                                    justifyContent:"space-between", alignItems:"center" }}>
                                        ...
                                        <>
                                          {filterTrue&&filterTrueInvPaid ? (
                                           ...
                                           {loadingState?
                                            <>
                        <img src={GreenLoader} height={20} width={20} />
                            ...
                            {dropdownStatusState ===
                                                "Online Payment"&&paymentResubmitState === item?.id && (
                              <>
                                <StyledBoldP>
                                  * Please upload your payment receipt
                                </StyledBoldP>
                                <StyledPaymentDetails>
                                    ...
                                    <p className="view_detail" onClick={()=>{setModalInvoiceState(true);
                                    setModalInvoiceData({...modalInvoiceData,
                                    invoiceNumber:item?.invoiceNumber,
                                    invoiceStatus:item?.invoiceStatus,
                                    invoiceAmount:item?.invoiceAmount,
                                    receiptDate:item?.receiptDate})}}>View Details</p>
                                  </StyledPaymentDetails>
                                {/* {console.log('itemIoku',item)} */}
                             <CustomButton customStyle={{ 
                              ...
                              onClick={() => {
                                if (goSellLoaded) {
                                  goSell.config({
                                    gateway: {
                                      publicKey: `${process.env.NEXT_TAP_PUBLIC_KEY}`,
                                      merchant_id: `${process.env.NEXT_TAP_MERCHANT_ID}`,
                                      language: "en",
                                      contactInfo: false,
                                    ...
                                    customer: {
                                      first_name: dashboardTrackAppState?._UserDetailsViewModel?.firstName_EN,
                                      middle_name: dashboardTrackAppState?._UserDetailsViewModel?.firstName_EN,
                                      last_name: dashboardTrackAppState?._UserDetailsViewModel?.lastName_EN,
                                    ...
                                    order: {
                                      ...
                                      items: [
                                        {
                                          id: 0,
                                          name: `${dashboardTrackAppState?.courseTrainingTitle_EN}`,
                                          description: `${dashboardTrackAppState?.departmentName_EN}`,
                                          old_quantity: 1,
                                          quantity: 1,
                                          amount_per_unit: 0,
                                          old_total_amount: 0,
                                    ...
                                    transaction: {
                                      ...
                                      charge: {
                                        ...
                                        redirect: `${process.env.NEXT_PUBLIC_CLIENT_BASE_URL}/payment`,
                                        post: null,
                                      },
                                    },
                                  });
                                ...
                                >
                                  <StyledTimeLineRow>
                                    <StyledcommentsDiv>
                                      ...
                                      <p className="Light">
                                        Congratulations! your {dashboardTrackAppState?.courseTrainingRecordType_EN.toLowerCase()}{" "} has
                                        been approved. Please check your
