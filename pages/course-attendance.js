...
const EditTax = () => {
  ...
  const [selectItem, setSelectItem] = useState("course-attendance");
  const [attendanceState, setAttendanceState] = useState([]);
  const [calendarDate, setCalendarDate] = useState();

  const [classVenueFlagState,setClassVenueFlagState] = useState(false);
  ...
  useLayoutEffect(() => {
    const obj = {
      attendanceDate: calendarDate !== undefined ? moment(calendarDate) : moment(),
      dayMonth: "Month",
    ...
    const payloadObj=classVenueFlagState?obj1:obj

    const token = getCookies("token");
    //console.log("obj,token", obj, token);
    getFeaturedRecordFunc(payloadObj, token);
              ...
              >
                ...
                <AttendanceCalander>
                  ...
                  <MyCalendarComp
                    ...
                    setClassVenueFlagState={setClassVenueFlagState}
                    classVenueFlagState={classVenueFlagState}
                    CourseTrainingVenueLMSUserWiseState={
                      CourseTrainingVenueLMSUserWiseState
                    }
                    setCourseTrainingVenueLMSUserWiseInitialState={
