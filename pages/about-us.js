...
import OurStories from "../src/components/OurStories";
...
const AboutUsPage = ({ initialProps }) => {
              ...
              (data, index) => (
                <div key={index}>
                        ...
                        <Container>
                          <SectionAfterHeroRow>
                            {data["content"]?.tabs?.map((item, index) => (
                              <SectionAfterHeroCol
                                key={index}
                                onClick={() => router.push(`/${item?.link_en}`)}
                                span={8}
                              >
                                <Row>
                                  <AlignCenter>
                  ...
                  {data["type"] === "text_with_image" && (
                    <>
                      <AboutSection>
                            ...
                            {data["content"]?.align === "right" && (
                              <>
                                <StyledColImg
                                  ...
                                  xs={24}
                                >
                                  {/* <Image alt={""}src={IntroductionImage} /> */}
                                  {data["content"]?.image !== "" &&
                        ...
                        <SideDesignDiv>
                          {/* <Image alt={""}src={SideDesign} /> */}
                          <Image alt={""} height={500} width={500} src={SideDesign} />
                        </SideDesignDiv>{" "}
                      </AboutSection>
                    </>
                  )}
                  {data["type"] === "three_card" && (
                    <>
                      <LeadershipRow gutter={[52, 52]}>
                        {data["content"]?.cards?.map((item, index) => (
                          <Col span={5} key={index}>
                            <LeadershipCard>
                              {/* <Image alt={""}src={BoardOfTrust} /> */}
                              <Image alt={""}height={250} width={250} src={item?.image} />
                    ...
                    <>
                      ...
                      <OurAccreditationDiv>
                        ...
                        <OurAccreditationBgImgDiv>
                          {/* <Image alt={""}src={OurAccreditationImage} /> */}
                          <Image
                            height={500}
                            width={1350}
